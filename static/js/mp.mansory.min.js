!function (r) {
    r.fn.mpmansory = function (t) {
        var n = r.extend({
            ...
            distributeBy: {attr: "data-order", attrOrder: "asc", order: !1, height: !1},
            onload: function (r) {
                return !0
            }
        }, t)
        return Array.min = function (r) {
            ...
            return r(window).width() > 1200 ? "lg" : r(window).width() > 992 ? "md" : r(window).width() > 720 ? "sm" : r(window).width() > 480 ? "xs" : (r(window).width() > 320, "xs")
            ...
            var a = r(this), s = (a.getCurrentColumnSize(), n),
                o = "col-lg-" + t.breakpoints.lg + " col-md-" + t.breakpoints.md + " col-sm-" + t.breakpoints.sm + " col-xs-" + t.breakpoints.xs + " " + t.columnClasses
            ...
            var t = r(this), e = t.getCurrentColumnSize(), i = 12 / n.breakpoints[e],
                a = t.children("" != n.childrenClass ? "." + n.childrenClass : "div"), s = new Array,
                o = t.apply(n, i, s, a)
